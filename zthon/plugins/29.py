...
ZelzalDV_cmd = (
    "𓆩 [𓏺𝗦𝗼𝘂𝗿𝗰𝗲ᯓ𝗩𝗘𝗡𝗢𝗠𖠛. - اوامر الزخرفه ](https://t.me/K_o_c_3) 𓆪\n\n"
    " ⏎ اهلا بك في اوامر الزخرفه\n"
    " ⏎لاستعمال الامر ⏎ 𐇮.زخرفه + اسم الي تريدو\n"
    " تريدو لزخرفته ملحوظه عليك الاشتراك بقنوات التي ستظهر امامك \n"
    "\n𓆩 [𐇮 𓏺𝗦𝗼𝘂𝗿𝗰𝗲ᯓ الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/K_o_c_3) 𓆪"
    "\n𓆩 [𐇮 ⧛𝐕𝐄𝐍𝐎𝐌 الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/K_o_c_1) 𓆪"
)
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝐕𝐄𝐍𝐎𝐌☬ :**\n\n"
...
async def _(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت فينوم انتظـر 2-1 دقيقـه ▬▭ ...**"
    msg = await edit_or_reply(event, output)
    await event.client.reload(msg)
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت فينوم انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
