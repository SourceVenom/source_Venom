...
LOGS = logging.getLogger("سورس فينوم ")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3","K_o_c_3"]
